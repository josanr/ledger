...
class TransactionsController extends AbstractController
{
    ...
    #[OA\Post(requestBody: new OA\RequestBody(content: new Model(type: CreateTransactionRequest::class)))]
    #[OA\Response(
        response: 200,
        description: 'Successful response',
        content: new Model(type: TransactionItemResponse::class)
    )]
    #[OA\Response(response: 417, description: 'Could not store transaction')]
    #[OA\Response(response: 422, description: 'Request is invalid')]
    #[OA\Response(response: 500, description: 'Unexpected exception')]
    public function create(#[MapRequestPayload] CreateTransactionRequest $createTransactionRequest): Response
    {
        try {
