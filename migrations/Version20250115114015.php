...
final class Version20250115114015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ledger (id UUID NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(100) NOT NULL, description TEXT NOT NULL, ledger_type VARCHAR(50) NOT NULL, currency_id INT NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN ledger.id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE transaction (id UUID NOT NULL, ledger_id_id UUID NOT NULL, description TEXT NOT NULL, transaction_date TIMESTAMP(0) WITH TIME ZONE NOT NULL, amount INT NOT NULL, currency_id INT NOT NULL, direction VARCHAR(10) NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
